module app.exercises {
    ...
    export class AudioPlayer0 {
        ...
        setPlaying = (playing: boolean) => {
            //this.$scope.$evalAsync(() => { this.playing = playing; });
            this.$timeout(() => { this.playing = playing; });
        };
        ...
        positionFormatting = (value) => {
            return this.$filter<(value) => string>('appMsecToMinSec')(value);
        }
    ...
    export function RecordingsComparer0(a: IRemark, b: IRemark) {
