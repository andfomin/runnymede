...
insert dbo.libCategories (Id, ParentId, Name, Position, FeatureCode, Display) values ('101_', '100_', N'Reported speech (range of tenses)', null, '101', 1)
...
insert dbo.libCategories (Id, ParentId, Name, Position, FeatureCode, Display) values ('125_', '124_', N'Personal - subject', null, '125', 1)
...
insert dbo.libCategories (Id, ParentId, Name, Position, FeatureCode, Display) values ('331_', '330_', N'Arabic', null, null, 1)
insert dbo.libCategories (Id, ParentId, Name, Position, FeatureCode, Display) values ('332_', '330_', N'Chinese', null, null, 1)
insert dbo.libCategories (Id, ParentId, Name, Position, FeatureCode, Display) values ('333_', '330_', N'French', null, null, 1)
insert dbo.libCategories (Id, ParentId, Name, Position, FeatureCode, Display) values ('334_', '330_', N'German', null, null, 1)
insert dbo.libCategories (Id, ParentId, Name, Position, FeatureCode, Display) values ('335_', '330_', N'Indian', null, null, 1)
insert dbo.libCategories (Id, ParentId, Name, Position, FeatureCode, Display) values ('336_', '330_', N'Japanese', null, null, 1)
insert dbo.libCategories (Id, ParentId, Name, Position, FeatureCode, Display) values ('337_', '330_', N'Korean', null, null, 1)
insert dbo.libCategories (Id, ParentId, Name, Position, FeatureCode, Display) values ('338_', '330_', N'Spanish', null, null, 1)
