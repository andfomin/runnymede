    ...
    public class PersonalIndexHelper : LibraryIndexHelper
    {
        ...
        protected override dynamic GetIndexDefinition()
        {
            var fields = new IndexField[] 
                { 
                    new IndexField { Name = "uId_rId",           Type = "Edm.String",             Key = true,  Searchable = false, Filterable = false, Sortable = false, Facetable = false, Retrievable = true,  Suggestions = false },
                    new IndexField { Name = "userId",            Type = "Edm.Int32",              Key = false, Searchable = false, Filterable = true,  Sortable = false, Facetable = false, Retrievable = false, Suggestions = false },               
                    new IndexField { Name = "id",                Type = "Edm.Int32",              Key = false, Searchable = false, Filterable = false, Sortable = false, Facetable = false, Retrievable = true,  Suggestions = false },               
                    ...
                    new IndexField { Name = "categoryPathIds",   Type = "Collection(Edm.String)", Key = false, Searchable = false, Filterable = true,  Sortable = false, Facetable = true,  Retrievable = true,  Suggestions = false },
                    ...
                    new IndexField { Name = "comment",           Type = "Edm.String",             Key = false, Searchable = true,  Filterable = false, Sortable = false, Facetable = false, Retrievable = true,  Suggestions = false },
            };
